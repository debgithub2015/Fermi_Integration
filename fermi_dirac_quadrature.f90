...
! subroutines written below is updated upto 7th order derivative by DC
! Dated: 04/24/2014

      subroutine dfermi(dk,eta,theta,fd,fdeta,fdtheta, &
                        fdeta2,fdtheta2,fdetadtheta, &
                        fdeta3,fdeta4,fdeta5,fdeta6,fdeta7)
      include 'implno.dek'
...
! declare
      ...
      double precision dk,eta,theta,fd,fdeta,fdtheta, &
                       ...
                       res(4),drde(4),drdt(4),drde2(4),drdt2(4), &
                       drdet(4),drde3(4),drde4(4),drde5(4), &
                       drde6(4),drde7(4)
...
! 14 significant figure accuracy
      call dqleg020(fdfunc2, 0.d0,  s12, res(1), drde(1), drdt(1), &
                    drde2(1), drdt2(1), drdet(1), drde3(1), &
                    drde4(1), drde5(1), drde6(1), drde7(1), par,3)
      call dqleg020(fdfunc1,   s1,   s2, res(2), drde(2), drdt(2), &
                    drde2(2), drdt2(2), drdet(2), drde3(2), &
                    drde4(2), drde5(2), drde6(2), drde7(2), par,3)
      call dqleg020(fdfunc1,   s2,   s3, res(3), drde(3), drdt(3), &
                    drde2(3), drdt2(3), drdet(3), drde3(3), &
                    drde4(3), drde5(3), drde6(3), drde7(3), par,3)
      call dqlag020(fdfunc1,   s3, 1.d0, res(4), drde(4), drdt(4), &
                    drde2(4), drdt2(4), drdet(4), drde3(4), &
                    drde4(4), drde5(4), drde6(4), drde7(4), par,3)
...
! sum the contributions
      ...
      fdeta4       = drde4(1)  + drde4(2)  + drde4(3)  + drde4(4)
      fdeta5       = drde5(1)  + drde5(2)  + drde5(3)  + drde5(4)
      fdeta6       = drde6(1)  + drde6(2)  + drde6(3)  + drde6(4)
      fdeta7       = drde7(1)  + drde7(2)  + drde7(3)  + drde7(4)
      return
      end
...
! local variables
      double precision dk,eta,theta, &
                       ...
                       fact0,fact1,fact2,fact3,fact4,fact5,fact6
...
!added by DC 04/24/2014
       fact0       = (factor**2 + 1.d0 - 4.d0*factor)
       fdeta3      = (fact0*fdeta2)/(factor**2-1.d0)
       fdeta4      = (factor**3 -1.d0 -11.d0*factor**2+11.d0*factor)* &
                     fdeta3/((factor+1.d0)*fact0)
       fact1 = (factor**4+1.d0+66.d0*factor**2-26.d0*factor**3 &
                -26.d0*factor)
       fact2 = (factor**4-1.d0-10.d0*factor**3+10.d0*factor)
       fdeta5      = (fact1*fdeta4)/fact2
       fact3 = (factor**5-1.d0-57.d0*factor**4+302.d0*factor**3- &
               302.d0*factor**2+ 57.d0*factor)
       fact4       = (factor+1.d0)*fact1
       fdeta6      = (fact3*fdeta5)/fact4
       fact5 = (factor**6+1.d0-2416.d0*factor**3-120.d0*factor**5+ &
               1191.d0*factor**4+1191.d0*factor**2-120.d0*factor**5)
       fact6 = (factor**6-1.d0-56.d0*factor**5+245.d0*factor**4- &
               245.d0*factor**2+56.d0*factor)
       fdeta7      = (fact5*fdeta7)/fact6
...
!           result - result of the 10-point gauss formula
      ...
      subroutine dqleg020(f,a,b,result,drdeta,drdtheta, &
                          ...
                          drdeta3,drdeta4,drdeta5,drdeta6,drdeta7,&
                          par,n)
      include 'implno.dek'
!
...
! declare
      ...
      double precision a,b,result,drdeta,drdtheta, &
                       ...
                       fval(2),deta(2),dtheta(2), &
                       deta2(2),dtheta2(2),detadtheta(2),&
                       deta3(2),deta4(2),deta5(2),deta6(2),deta7(2)
...
!           result - result of the 20-point gauss formula
      ...
      do j=1,10
        ...
        call f(absc1, par, n, fval(1), deta(1), dtheta(1), &
               deta2(1), dtheta2(1), detadtheta(1), &
               deta3(1),deta4(1),deta5(1),deta6(1),deta7(1))
        call f(absc2, par, n, fval(2), deta(2), dtheta(2), &
               deta2(2), dtheta2(2), detadtheta(2),&
               deta3(2),deta4(2),deta5(2),deta6(2),deta7(2))
        ...
        drdeta4      = drdeta4   + (deta4(1)   + deta4(2))*wg(j)
        drdeta5      = drdeta5   + (deta5(1)   + deta5(2))*wg(j)
        drdeta6      = drdeta6   + (deta6(1)   + deta6(2))*wg(j)
        drdeta7      = drdeta7   + (deta7(1)   + deta7(2))*wg(j)
      enddo
      ...
      drdeta4      = drdeta4 * hlfrun
      drdeta5      = drdeta5 * hlfrun
      drdeta6      = drdeta6 * hlfrun
      drdeta7      = drdeta7 * hlfrun
      return
      end
...
!           result - result of the 10-point gauss formula
      ...
      subroutine dqlag020(f,a,b,result,drdeta,drdtheta, &
                          drdeta2,drdtheta2,drdetadtheta,&
                          drdeta3,drdeta4,drdeta5,drdeta6,drdeta7,par,n)
      include 'implno.dek'
!
...
! declare
      ...
      double precision a,b,result,drdeta,drdtheta, &
                       ...
                       deta2,dtheta2,detadtheta,deta3,deta4,&
                       deta5,deta6,deta7
...
!           result - result of the 20-point gauss formula
      ...
      do j=1,20
       ...
       call f(absc, par, n, fval, deta, dtheta, &
              deta2,dtheta2,detadtheta,drdeta3,&
             drdeta4,drdeta5,drdeta6,drdeta7)
       ...
       drdeta4      = drdeta4   + deta4*wg(j)
       drdeta5      = drdeta5   + deta5*wg(j)
       drdeta6      = drdeta6   + deta6*wg(j)
       drdeta7      = drdeta7   + deta7*wg(j)
      enddo
